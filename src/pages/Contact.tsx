...
const channels = [
{
  icon: Mail,
  labelKey: 'email',
  value: 'dhiabenamri@aol.com',
  href: 'mailto:dhiabenamri@aol.com',
},
{
  icon: Phone,
  labelKey: 'phone',
  value: '+213 770 640 330',
  href: 'tel:+213770640330',
},
{
  icon: MessageCircle,
  labelKey: 'whatsapp',
  value: '+213 776 505 079',
  href: 'https://wa.me/213776505079',
},
{
  icon: MapPin,
  labelKey: 'location',
  value: 'ُEverywhere, Algeria',
  href: '#',
},
];
